...
pub fn digit_count(n: Int) -> Result(Int, Nil) {
  ...
  digits(value, base) |> result.map(list.length)
}

/// Converts an integer to a list of digits in the given base.
/// Copied from Gleam stdlib
...
/// Converts a list of digits in the given base back to an integer.
/// Copied from Gleam stdlib
